give @s music_disc_far[\
    ...
    minecraft:custom_data={terminal_drive:{\
        pages:1,\
        inventory:[\
            {components:{"minecraft:custom_name":"Save Drive","minecraft:custom_data": {ui_item:{cmd:"function entityjy:repository/ui/drives/load_main_menu with storage entityjy:repository temp.ui.button"}}}, count: 1, Slot:0b, id: "minecraft:magenta_stained_glass_pane"},\
