...
execute if score @s raycast_steps_terminal matches 1..60 if data block ~ ~ ~ components.minecraft:custom_data.terminal run summon minecraft:marker ~ ~ ~ {Tags:["terminal"], CustomName:'Terminal'}
