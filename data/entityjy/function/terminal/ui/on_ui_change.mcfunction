...
$execute if data storage entityjy:repository terminals[{ID:$(ID)}].ui.temp[0] unless data storage entityjy:repository terminals[{ID:$(ID)}].ui.temp[1] run function entityjy:terminal/ui/menu/on_click with storage entityjy:repository terminals[{ID:$(ID)}]
