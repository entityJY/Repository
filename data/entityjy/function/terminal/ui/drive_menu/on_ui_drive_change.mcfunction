...
$data modify block ~ ~ ~ Items set from storage entityjy:repository internals.terminal.drive_scheme_$(terminal)
...
data modify block ~ ~ ~ Items[{components:{"minecraft:custom_data":{terminal_drive:{}}}}].components.minecraft:custom_data merge value {ui_item:{cmd:"function entityjy:terminal/ui/drives/load_drive with storage entityjy:repository temp.ui.button"}}
...
$data modify storage entityjy:repository terminals[{id:$(id)}].main_menu set from block ~ ~ ~ Items
# save Items to terminal.main_menu_prev, append prev:1b
$data modify storage entityjy:repository terminals[{id:$(id)}].main_menu_prev set from block ~ ~ ~ Items
$data modify storage entityjy:repository terminals[{id:$(id)}].main_menu_prev[].components.minecraft:custom_data merge value {prev:1b}
