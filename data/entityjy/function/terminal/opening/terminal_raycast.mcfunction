...
execute if score @s raycast_steps_terminal matches 1..60 if data block ~ ~ ~ components.minecraft:custom_data.terminal as @e[type=minecraft:marker, tag=terminal, sort=nearest, limit=1] run function entityjy:terminal/opening/terminal_found
