...
$summon minecraft:slime $(x) $(y) $(z) {Invulnerable:1b, NoAI: 1b, attributes:[{id:"minecraft:generic.scale", base: 2.0d}, {id:"minecraft:generic.attack_damage", base: 0.0d}], CustomName:'{"text":"Terminal Locked"}', DeathLootTable:''}
