...
execute store result storage entityjy:repository temp.terminal_placed.id int 1 run scoreboard players add #new repository_id 1
...
function entityjy:repository/placing/set_terminal_storage with storage entityjy:repository temp.terminal_placed