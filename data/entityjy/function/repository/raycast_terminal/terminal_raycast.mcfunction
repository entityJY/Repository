...
execute if score @s raycast_steps_repository2 matches 1..60 if data block ~ ~ ~ components.minecraft:custom_data.repository run return run function entityjy:repository/raycast_terminal/terminal_found
